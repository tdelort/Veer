...
namespace veer
{
	...
	public:
		...
		void fill_resource(ComPtr<ID3D12Resource> _dx12_resource, dx12_descriptor _descriptor);

		ComPtr<ID3D12Resource> get_resource();
		dx12_descriptor& get_cpu_descriptor_handle();
